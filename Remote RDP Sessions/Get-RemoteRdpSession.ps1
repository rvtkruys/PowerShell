<#
    ...
    .EXAMPLE
        Get-RemoteRdpSession  -ComputerName $(Get-AdComputer -filter {name -like "*VWAPP*"} | select-object -exp name) 

    .EXAMPLE
        Get-RemoteRdpSession  -ComputerName FRA0VWWEB01 -State Disc
    .EXAMPLE 
        Get-RemoteRdpSession  -ComputerName FRA0VWWEB01
